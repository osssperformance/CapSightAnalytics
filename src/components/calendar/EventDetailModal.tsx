        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-600">
                <span>{formatDate(calendarDate, 'long')}</span>
                <span>•</span>
                <span className={`px-2 py-0.5 rounded text-xs font-medium ${getEventTypeBadge(event.event_type)}`}>
          ...
          <div className="px-6 py-6 space-y-6">
            ...
            <div>
              ...
              >
                <div className="flex-1">
                  <div className="font-semibold text-gray-900 group-hover:text-primary">{event.company_name}</div>
                  <div className="text-sm text-gray-600">{event.asx_code}</div>
                </div>
            ...
            {event.commodities && event.commodities.length > 0 && (
              <div>
                <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Commodities</h3>
            ...
            {event.importance_score && (
              <div>
                <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Importance</h3>
            ...
            {/* Share */}
            <div>
              <h3 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Share</h3>
              <div className="flex flex-wrap gap-2">
                <button
                  onClick={() => handleShare('twitter')}
                  className="flex items-center gap-2 px-4 py-2 bg-[#1DA1F2] text-white rounded-md hover:bg-[#1a8cd8] transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-[#0077B5] text-white rounded-md hover:bg-[#006399] transition-colors"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
